    ...
    <div className="grid max-h-215 grid-cols-9 grid-rows-6 gap-6">
      ...
      >
        <Image
          ...
          quality={100}
          alt=""
          className="-mb-18 transition-transform duration-500 group-hover:scale-105"
        />
        ...
        return (
          ...
          >
            <Image
              ...
              quality={100}
              alt=""
              className="-mb-10 align-bottom transition-transform duration-500 group-hover:scale-105"
            />
